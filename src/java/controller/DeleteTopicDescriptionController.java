 ...
 * @author Mr.Khuong
 */
@WebServlet(name = "DeleteTopicDescriptionController", urlPatterns = {"/DeleteTopicDescriptionController"})
public class DeleteTopicDescriptionController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = dao.delete(descriptionID);
            if (check) {
                url = SUCCESS;
            }
        } catch (Exception e) {
            log("Error at DeleteTopicDescriptionController" + e.toString());
        } finally {
